  ...
  protected function accessTestScenarios(): array {
    return [
      ...
      'user with update access' => [
        'permissions' => ['edit oe_corporate_entity_test test_bundle corporate entity'],
        'operation' => 'update',
        'expected_result' => AccessResult::allowed()->addCacheContexts(['user.permissions']),
        'status' => 1,
      ],
      'user with update access on different bundle' => [
        'permissions' => ['edit oe_corporate_entity_test another_test_bundle corporate entity'],
        'operation' => 'update',
        'expected_result' => AccessResult::neutral()->addCacheContexts(['user.permissions']),
        'status' => 1,
      ],
      ...
      'user with delete access' => [
        'permissions' => ['delete oe_corporate_entity_test test_bundle corporate entity'],
        'operation' => 'delete',
        'expected_result' => AccessResult::allowed()->addCacheContexts(['user.permissions']),
        'status' => 1,
      ],
      'user with delete access on different bundle' => [
        'permissions' => ['delete oe_corporate_entity_test another_test_bundle corporate entity'],
        'operation' => 'delete',
        'expected_result' => AccessResult::neutral()->addCacheContexts(['user.permissions']),
        'status' => 1,
      ],
  ...
  protected function createAccessTestScenarios(): array {
    return [
      ...
      'user with create access on different bundle' => [
        'permissions' => ['create oe_corporate_entity_test another_test_bundle corporate entity'],
        'expected_result' => AccessResult::neutral()->addCacheContexts(['user.permissions']),
      ],
    ];
  }

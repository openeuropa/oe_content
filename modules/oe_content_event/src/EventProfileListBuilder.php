...
/**
 * Defines a class to build a listing of Event profile entities.
 *
 * @ingroup oe_content_event
 */
class EventProfileListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new EventProfileListBuilder object.
   *
  ...
  public function buildHeader() {
    $header['id'] = $this->t('Event profile');
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\oe_content_event\Entity\EventProfile $entity */

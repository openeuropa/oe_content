...
/**
 * Form controller for Event profile edit forms.
 *
...
class EventProfileForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new EventProfileForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state): void {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger->addMessage($this->t('Created the %label Event profile.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger->addMessage($this->t('Saved the %label Event profile.', [
          '%label' => $entity->label(),
        ]));
    }
    $form_state->setRedirect('entity.event_profile.canonical', ['event_profile' => $entity->id()]);
  }

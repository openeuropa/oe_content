...
function oe_content_news_post_update_00002(array &$sandbox): void {
  $fields_description = [
    'node.oe_news.title' => 'The ideal length is 50 to 60 characters including spaces. If it must be longer, make sure you fill in a shorter version in the Alternative title field.',

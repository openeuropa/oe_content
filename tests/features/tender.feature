...
Feature: Call for Tenders content creation
  ...
  Scenario: Creation of a Call for Tender content through the UI.
    ...
    And I fill in "Publication date" with the date "07-14-2020"
    And I fill in "Opening" with the date "07-24-2020"
    And I fill in "Deadline" with the date "07-31-2020"
    And I fill in "Deadline" with the time "11:59:59PM"
    ...
    And I click the fieldset "Main content"
    ...
    And I should see "07/31/2020 - 23:59"
